...
public class TestEC {
    public static final Logger LOG =
            LoggerFactory.getLogger(org.apache.hadoop.hdfs.TestErasureCodingMultipleRacks.class);
    ...
    public void testSkewedRack2() throws Exception {
        final int dataUnits = ecPolicy.getNumDataUnits();
        final int parityUnits = ecPolicy.getNumParityUnits();
        setupCluster(dataUnits + parityUnits, dataUnits, dataUnits - 1);
        ...
        dnd3.startDecommission();
        datanodeManager.getDatanodeAdminManager().startDecommission(dnd3);
        TimeUnit.SECONDS.sleep(10);
        System.err.println("______________________________"+dnd3.getAdminState());
